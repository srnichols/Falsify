...
- **Check OpenBrain** (if configured): `search_thoughts("<plan topic> review", project: "Falsify")` — load prior review findings, recurring issues, and known patterns
...
- **Before auditing**: `search_thoughts("all decisions for this phase", project: "Falsify", created_by: "copilot-vscode", type: "decision")` — load the full decision trail from planning and execution sessions for drift comparison
- **After verdict**: `capture_thought("Review verdict: PASS/FAIL — N findings, details: ...", project: "Falsify", created_by: "copilot-vscode", source: "plan-forge-step-5-review", type: "postmortem")` — persist the review outcome and any violations found
