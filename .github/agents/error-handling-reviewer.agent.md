...
- **Before reviewing**: `search_thoughts("error handling patterns", project: "Falsify", created_by: "copilot-vscode", type: "convention")` — load prior error handling decisions and accepted patterns
- **After review**: `capture_thought("Error handling review: N findings — [key issues]", project: "Falsify", created_by: "copilot-vscode", source: "error-handling-reviewer", type: "postmortem")` — persist findings for trend tracking
