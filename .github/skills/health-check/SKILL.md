...
- No unresolved `Falsify` placeholders
...
- **Before checking**: `search_thoughts("setup issue", project: "Falsify", created_by: "copilot-vscode", type: "bug")` — load prior setup issues and recurring health check failures
- **After check**: `capture_thought("Health check: <summary of findings>", project: "Falsify", created_by: "copilot-vscode", source: "skill-health-check")` — persist environment issues for future diagnostics
