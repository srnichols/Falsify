...
- **Before review**: `search_thoughts("clean code finding", project: "Falsify", created_by: "copilot-vscode", source: "skill-clean-code-review")` — surface recurring violations and prior triage decisions
- **After review**: `capture_thought("Clean code review: <summary — N errors / M warnings, top finding>", project: "Falsify", created_by: "copilot-vscode", source: "skill-clean-code-review")` — track quality trend over time
