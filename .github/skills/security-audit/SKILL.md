...
- **Before auditing**: `search_thoughts("security audit", project: "Falsify", created_by: "copilot-vscode", type: "bug")`
- **After audit**: `capture_thought("Security audit (Node.js): <summary>", project: "Falsify", created_by: "copilot-vscode", source: "skill-security-audit", type: "bug")`
