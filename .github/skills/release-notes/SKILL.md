...
- **Before generating notes**: `search_thoughts("release", project: "Falsify", created_by: "copilot-vscode", type: "decision")` — load prior release decisions, breaking change precedents, and versioning conventions
- **After release notes are finalized**: `capture_thought("Release: v<version> — <key changes summary>", project: "Falsify", created_by: "copilot-vscode", source: "skill-release-notes")` — persist release history for future changelog continuity
